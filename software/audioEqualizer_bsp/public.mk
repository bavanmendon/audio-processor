...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../audioProcessor.sopcinfo
...
# CPU Name 
# setting CPU_NAME is NIOSAudioProcessor
CPU_NAME = NIOSAudioProcessor
...
# Design Name 
# setting SOPC_NAME is audioProcessor
SOPC_NAME := audioProcessor
