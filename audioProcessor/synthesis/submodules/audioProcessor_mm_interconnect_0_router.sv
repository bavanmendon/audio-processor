...
module audioProcessor_mm_interconnect_0_router_default_decode
  #(
...
module audioProcessor_mm_interconnect_0_router
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    localparam PAD10 = log2ceil(64'h210b8 - 64'h210b0); 
    // -------------------------------------------------------
    ...
    audioProcessor_mm_interconnect_0_router_default_decode the_default_decode(
